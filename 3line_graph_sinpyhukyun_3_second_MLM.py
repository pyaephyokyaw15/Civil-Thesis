...
# data
years = data.T
calculated_wind_speeds = data.SINPHYUKYUN_3_SECOND_WT
UCL_95 = data.SINPHYUKYUN_3_SECOND_UCL_95
LCL_95 = data.SINPHYUKYUN_3_SECOND_LCL_95
...
plt.title('Sinphyukyun 3 seconds')
