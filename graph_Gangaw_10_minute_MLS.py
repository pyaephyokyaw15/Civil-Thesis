...
recorded_wind_speeds = data.GANGAW_10_MINUTE_WIND_SPEED
calculated_wind_speeds = data.GANGAW_10_MINUTE_WIND_Wi_star
...
plt.plot(years, calculated_wind_speeds, marker='s', linestyle='-', label='Gumbel using MLS')
